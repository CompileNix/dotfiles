...
| `dua-cli`            | [dua](https://crates.io/crates/dua-cli)                           | Disk Usage Analyzer (DUA) is a tool to conveniently learn about the disk usage of directories, fast!                                                           | rust, cli, du, ncdu, disk usage        |
