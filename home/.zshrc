...
alias ctop='docker run --name=ctop-$(cat /dev/random | tr -dc "0-9a-f" | head -c 8 | awk "{ print $1 }") --rm -ti --volume "/var/run/docker.sock:/var/run/docker.sock:ro,z" --volume "$HOME/.ctop:/.ctop:rw,z" quay.io/vektorlab/ctop:latest'
