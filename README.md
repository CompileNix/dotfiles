...
| `amdgpu_top`         | [amdgpu_top](https://crates.io/crates/amdgpu_top)                 | Tool to displays AMDGPU usage. The tool displays information gathered from performance counters (GRBM, GRBM2), sensors, fdinfo, gpu_metrics and AMDGPU driver.                           | rust, cli, tui, gui, video             |
...
| `dua`                | [dua](https://crates.io/crates/dua)                               | Disk Usage Analyzer (DUA) is a linux console application to display what uses the most space in the specified directories. Think about it as a console version of KDirStat or WinDirStat | rust, cli, du, ncdu, disk usage        |
...
| `mprocs`             | [mprocs](https://crates.io/crates/mprocs)                         | TUI for running multiple processes                                                                                                                                                       | rust, cli, tui                         |
...
gsettings set org.gnome.settings-daemon.plugins.media-keys.custom-keybinding:/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/custom2/ command 'busctl --user call org.gnome.Shell.ScreenShield /org/gnome/ScreenSaver org.gnome.ScreenSaver SetActive b true'
